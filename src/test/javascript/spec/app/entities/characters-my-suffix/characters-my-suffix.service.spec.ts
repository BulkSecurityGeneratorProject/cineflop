...
describe('Service Tests', () => {
    ...
    describe('CharactersMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CharactersMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/characters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CharactersMySuffix', () => {
